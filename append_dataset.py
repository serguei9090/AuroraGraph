...
new_cases = [
  ...
  },
  {
    ...
    "expected_keywords": ["Endurantism", "Perdurantism", "temporal parts", "entirely present", "four-dimensional"],
  ...
  },
  {
    ...
    "expected_keywords": ["intentionality", "Husserl", "Heidegger", "Dasein", "ready-to-hand"],
